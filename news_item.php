...
<head>
    ...
    <title><?
															if(isset($_GET['id']))
															{
																...
																$GetItem = mysql_query("SELECT * FROM news WHERE id='".$id."'");
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/ru_RU/sdk.js#xfbml=1&version=v2.10&appId=1858364424403020";
...
<!-- The Modal -->
	...
	<? $actual_link = 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];?>
	   <div class="fb-comments" data-href="<?$actual_link?>" data-width="1000px" data-numposts="3"></div>
