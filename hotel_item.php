...
if(isset($_POST[full]) and isset($_POST[mob]) and isset($_POST[email]) and isset($_GET[id]) and $_GET[act] == 'sent')
{
	...
	else
	{
		...
		$InsertOrder = mysql_query("INSERT INTO orders_hot(`qty`,`hotel_id`,`user`,`mobile`,`email`,`date`) VALUES('$qty','$id','$name','$mobile','$email','$date')") or die(mysql_error());
		if($InsertOrder == true)
		{
...
<head>
    ...
    <title><?
															...
															{
																$id = trim(strip_tags(mysql_real_escape_string($_GET[id])));
																$GetItem = mysql_query("SELECT * FROM hotels WHERE id='".$id."'");
 ...
 <?php include "includes/header.php"; ?>
	...
	<div id="myModal" class="modal">
		...
		<div class="modal-content">
		 <span class="close">&times;</span>
    <div class="lb-header">
      <a href="#" class="active geo-font" id="login-box-link">შესვლა</a>
      <a href="#" class="geo-font" id="signup-box-link">რეგისტრაცია</a>
    </div>
    <div class="social-login">
      <a href="#">
        <i class="fa fa-facebook fa-lg geo-font"></i>
        შესვლა facebook-ით
      </a>
      <a href="#">
        <i class="fa fa-google-plus fa-lg geo-font"></i>
        შესვლა Google-ით
      </a>
    </div>
    <form class="email-login">
      <div class="u-form-group">
        <input class = "geo-font" type="email" placeholder="იმეილი"/>
      </div>
      <div class="u-form-group">
        <input class = "geo-font" type="password" placeholder="პაროლი"/>
      </div>
      <div class="u-form-group">
        <button class = "geo-font">შესვლა</button>
      </div>
      <div class="u-form-group">
        <a href="#" class="forgot-password geo-font">დაგავიწყდათ პაროლი?</a>
      </div>
    </form>
    <form class="email-signup ">
      <div class="u-form-group">
      ...
      <div class="u-form-group">
        <input class = "geo-font" type="password" placeholder="გაიმეორეთ პაროლი"/>
      </div>
      <div class="u-form-group">
        <button class = "geo-font">რეგისტრაცია</button>
      </div>
    </form>
  </div>
 </div>
	...
	<?
	$id = trim(strip_tags(mysql_real_escape_string($_GET[id])));
	$GetHotels = mysql_query("SELECT * FROM hotels WHERE id='$id'");
	$GetHotelsRow = mysql_fetch_array($GetHotels);
	
	echo '<h2>'.$GetHotelsRow[name_geo].'</h2>
  ...
  <div class="slider">
    <div class="slider--item" style="background-image: url('.$GetHotelsRow[pic1].')">
    </div>
	<div class="slider--item" style="background-image: url('.$GetHotelsRow[pic2].')">
    </div>
	<div class="slider--item" style="background-image: url('.$GetHotelsRow[pic3].')">
    </div>
	<div class="slider--item" style="background-image: url('.$GetHotelsRow[pic4].')">
    </div>
	<div class="slider--item" style="background-image: url('.$GetHotelsRow[pic5].')">
    </div>
  </div>
</div>
			</div>
		...
		<div id = "tour-desc">
		<p>'.$GetHotelsRow[l_description_geo].'</p><br><a href="#" id="bookbutton" class="button geo-font">სასტუმროს შეკვეთა</a>
...
<!-- The Modal -->
    ...
    <div class="lb-header">
      <h2 class = "geo-font" >
	<form action="hotel_item.php?id=<? echo $_GET[id]; ?>&act=sent" method="POST">
     <div class="u-form-group">
    ...
    <span class="choose">ტურისტის რაოდენობა</span>
  
      <div class="drop-menu">
	  <!--
        <div class="select">
          <span>აირჩიეთ ტურისტების რაოდენობა</span>
