...
<?php include "includes/header.php"; ?>	
   <div class = "spacer"></div>
	...
	<h2>მომსახურების პაკეტები</h2>
		...
		<?
			$GetHotels = mysql_query("SELECT * FROM hotels ORDER BY id DESC") or die(mysql_error());
			$GetHotelsRow = mysql_fetch_array($GetHotels);
			do
			{
			echo '<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="hotel_item.php?id='.$GetHotelsRow[id].'"><img width="90%" height="90%" src="'.$GetHotelsRow[main_pic].'" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="hotel_item.php?id='.$GetHotelsRow[id].'">'.$GetHotelsRow[price_1_GEL].'GEL - დან </a></span>
				<h4 class="fh5co-article-title"><a href="hotel_item.php?id='.$GetHotelsRow[id].'">'.$GetHotelsRow[name_geo].'</a></h4>
				
			</article>';
			}
			while($GetHotelsRow = mysql_fetch_array($GetHotels));
			?>
		</div>
	</div>
	...
	<footer class="footer-distributed ">
			...
			<div class="footer-left geo-font go">

			<span> <img src="img/logo.png" alt="Smiley face" height="100" width="100"></span>
				...
				<p class="footer-company-name">ჯეოსქაი &copy; 2017 ALL RIGHTS RESERVED</p>
			</div>
			...
			<div class="footer-center">
				...
				<div>
					...
					<p><span>ალექსანდრე გრიბოედოვის N32</span> თბილისი, საქართველო</p>
				</div>
				...
				<div>
					...
					<p><a href="mailto:support@company.com">GeoSky4u@gmail.com</a></p>
				</div>

			</div>

			<div class="footer-right geo-font">
